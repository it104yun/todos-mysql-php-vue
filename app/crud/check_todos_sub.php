...
// 這裡只更新 completed 欄位。
$sql = "UPDATE sub_todos SET completed_date = :completed_date
        WHERE todos_id = :todos_id and item_id = :item_id";
...
try {
    ...
    $stmt->bindParam(':todos_id', $todos_id, PDO::PARAM_INT);
